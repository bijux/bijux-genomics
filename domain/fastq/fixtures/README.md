...
- `fastq.demultiplex_reads`: intent = stage-specific command contract coverage for `fastq.demultiplex_reads`.
...
- `fastq.repair_pairs`: intent = stage-specific command contract coverage for `fastq.repair_pairs`.
...
- `fastq.subsample_reads`: intent = stage-specific command contract coverage for `fastq.subsample_reads`.
