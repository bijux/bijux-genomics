...
pub fn bench_corpus(id: BenchCorpusId) -> BenchCorpus {
    ...
    let datasets = match id {
        BenchCorpusId::Fastq5Set => vec![
            BenchDataset {
                id: "ERR2112797",
                r1: root.join("tests/data/fastq/ERR2112797/ERR2112797_1.fastq.gz"),
                r2: Some(root.join("tests/data/fastq/ERR2112797/ERR2112797_2.fastq.gz")),
            ...
            BenchDataset {
                id: "ERR769587",
                r1: root.join("tests/data/fastq/ERR769587/ERR769587.fastq.gz"),
                r2: None,
            ...
            BenchDataset {
                id: "ERR769592",
                r1: root.join("tests/data/fastq/ERR769592/ERR769592.fastq.gz"),
                r2: None,
            ...
            BenchDataset {
                id: "BIJUX_SE_R1",
                r1: root.join("tests/data/fastq/canonical/BIJUX_SE_R1.fastq.gz"),
                r2: None,
            ...
            BenchDataset {
                id: "BIJUX_PE",
                r1: root.join("tests/data/fastq/canonical/BIJUX_PE_R1.fastq.gz"),
                r2: Some(root.join("tests/data/fastq/canonical/BIJUX_PE_R2.fastq.gz")),
