...
pub fn check_registry() -> Vec<CheckDefinition> {
    vec![
        ...
        native("check-ci-shell-scripts", NativeCheckKey::CiShellScripts),
        ...
        native("check-no-temp-leaks", NativeCheckKey::NoTempLeaks),
        native(
        ...
        native("check-script-arg-style", NativeCheckKey::ScriptArgStyle),
        native("check-script-deps", NativeCheckKey::ScriptDeps),
        native("check-script-entrypoint", NativeCheckKey::ScriptEntrypoint),
        native("check-script-help", NativeCheckKey::ScriptHelp),
        native("check-script-interface", NativeCheckKey::ScriptInterface),
        native("check-script-writes", NativeCheckKey::ScriptWrites),
        native("check-shell-portability", NativeCheckKey::ShellPortability),
        ...
        native("check-supported-scripts", NativeCheckKey::SupportedScripts),
        ...
        CheckDefinition {
            id: "tree-intent",
            version: 1,
            summary: "Validate that each scripts subtree declares a durable purpose.".to_string(),
            aliases: &[],
            execution_mode: ExecutionMode::Alias,
            command: CommandSpec::Native {
                key: NativeCheckKey::TreeIntent,
            },
        },
    ]
}
