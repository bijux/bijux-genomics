...
Provides versioned control-plane automation for repository checks and other developer workflows.
...
## Notes
This crate owns the durable registry and execution surface for repository checks.
