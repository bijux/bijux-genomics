...
use bijux_dna_benchmark_model::BenchError;
...
pub trait RunRepository {
    ...
    fn load_observations(
        &self,
        run_id: &str,
    ) -> Result<Vec<bijux_dna_benchmark_model::BenchmarkObservation>>;
}
...
pub fn load_observations(
    ...
    for line in raw.lines() {
        ...
        let obs: bijux_dna_benchmark_model::BenchmarkObservation = serde_json::from_str(line)?;
