...
use bijux_dna_benchmark_model::compare::{compare_summaries, CompareReport};
use bijux_dna_benchmark_model::contract::{
    validate_decision, validate_observation, validate_suite, validate_summary,
};
use bijux_dna_benchmark_model::policy::{GateDecision, GatePolicy};
use bijux_dna_benchmark_model::stats::{bootstrap_ci, mad_outliers, robust_stats, seed_from_ids};
use bijux_dna_benchmark_model::{
...
mod tests {
    ...
    use bijux_dna_benchmark_model::GatePolicy;
    use bijux_dna_benchmark_model::{
