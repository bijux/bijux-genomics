...
## What
Authoritative registry of policy tests owned by `bijux-dna-policies`.
...
| `tests/surface/guardrails.rs` | surface | Run guardrails for bijux-dna-policies. | `docs/ENFORCEMENT.md` |
