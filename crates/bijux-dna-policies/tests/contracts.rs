...
#[path = "contracts/tooling/tool_role_capability_policy.rs"]
mod mod_contracts_tooling_tool_role_capability_policy_rs;
#[path = "contracts/tooling/toy_golden_runs_policy.rs"]
...
#[path = "contracts/tooling/vcf_gl_propagation_policy.rs"]
