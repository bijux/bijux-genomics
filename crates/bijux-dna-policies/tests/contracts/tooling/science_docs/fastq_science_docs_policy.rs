...
#[test]
fn policy__contracts__fastq_science_docs_policy__primer_assumptions_link_governed_primer_surfaces_exactly(
) {
    let expected = BTreeSet::from([
        "../../../domain/fastq/stages/prepare_primer_bank.yaml".to_string(),
        "../../../domain/fastq/stages/normalize_primers.yaml".to_string(),
        "../../../domain/fastq/docs/DEFAULT_SETTINGS.md".to_string(),
    ]);
    let documented = markdown_link_targets("docs/20-science/fastq/PRIMER_ASSUMPTIONS.md");
    assert_eq!(
        expected, documented,
        "docs/20-science/fastq/PRIMER_ASSUMPTIONS.md must link the governed primer surfaces exactly"
    );
}

#[test]
fn policy__contracts__fastq_science_docs_policy__chimera_semantics_link_governed_chimera_surfaces_exactly(
) {
    let expected = BTreeSet::from([
        "../../../domain/fastq/stages/remove_chimeras.yaml".to_string(),
        "../../../domain/fastq/docs/DEFAULT_SETTINGS.md".to_string(),
        "REFERENCE_GOVERNANCE.md".to_string(),
    ]);
    let documented = markdown_link_targets("docs/20-science/fastq/CHIMERA_SEMANTICS.md");
    assert_eq!(
        expected, documented,
        "docs/20-science/fastq/CHIMERA_SEMANTICS.md must link the governed chimera surfaces exactly"
    );
}
...
#[test]
fn policy__contracts__fastq_science_docs_policy__normalization_semantics_link_governed_normalization_surfaces_exactly(
) {
    let expected = BTreeSet::from([
        "../../../domain/fastq/stages/normalize_abundance.yaml".to_string(),
        "../../../domain/fastq/metrics.yaml".to_string(),
        "../../../domain/fastq/docs/DEFAULT_SETTINGS.md".to_string(),
    ]);
    let documented = markdown_link_targets("docs/20-science/fastq/NORMALIZATION_SEMANTICS.md");
    assert_eq!(
        expected, documented,
        "docs/20-science/fastq/NORMALIZATION_SEMANTICS.md must link the governed normalization surfaces exactly"
    );
}

#[test]
fn policy__contracts__fastq_science_docs_policy__gold_pipeline_spec_links_governed_pipeline_surfaces_exactly(
) {
    let expected = BTreeSet::from([
    ...
    let documented = markdown_link_targets("docs/20-science/fastq/GOLD_PIPELINE_SPEC.md");
    assert_eq!(
        expected, documented,
        "docs/20-science/fastq/GOLD_PIPELINE_SPEC.md must link the governed pipeline surfaces exactly"
    );
}
...
#[test]
fn policy__contracts__fastq_science_docs_policy__metric_semantics_link_governed_metric_surfaces_exactly(
) {
    let expected = BTreeSet::from([
        "../../../domain/fastq/metrics.yaml".to_string(),
        "SCIENTIFIC_SPEC.md".to_string(),
    ...
    let documented = markdown_link_targets("docs/20-science/fastq/METRIC_SEMANTICS.md");
    assert_eq!(
        expected, documented,
        "docs/20-science/fastq/METRIC_SEMANTICS.md must link the governed metric surfaces exactly"
    );
}

#[test]
fn policy__contracts__fastq_science_docs_policy__operational_contract_links_governed_operational_surfaces_exactly(
) {
    let expected = BTreeSet::from([
    ...
    let documented = markdown_link_targets("docs/20-science/fastq/OPERATIONAL_CONTRACT.md");
    assert_eq!(
        expected, documented,
        "docs/20-science/fastq/OPERATIONAL_CONTRACT.md must link the governed operational surfaces exactly"
    );
}
...
#[test]
fn policy__contracts__fastq_science_docs_policy__stage_taxonomy_links_governed_stage_taxonomy_surfaces_exactly(
) {
    let expected = BTreeSet::from([
        "../../../domain/fastq/index.yaml".to_string(),
        "../../../domain/fastq/execution_support.yaml".to_string(),
    ...
    let documented = markdown_link_targets("docs/20-science/fastq/STAGE_TAXONOMY.md");
    assert_eq!(
        expected, documented,
