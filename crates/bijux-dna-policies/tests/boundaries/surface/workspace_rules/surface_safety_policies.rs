...
fn policy__boundaries__workspace__workspace_no_ad_hoc_fs_write() {
    ...
    let legacy_allowlist: BTreeSet<&str> = BTreeSet::from([
        ...
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/build_rrna_db.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/concatenate_lanes.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/detect_adapters.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/layout_classification.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/demultiplex_reads.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/fastq_io.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/trim_reads.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/deplete_reference_contaminants.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/estimate_library_complexity_prealign.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/build_taxonomy_db.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/detect_duplicates_premerge.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/detect_instrument_artifacts.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/edna_branch.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/deplete_host.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/prepare_host_reference_bundle.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/validate_reads.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/qc_manifest.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/build_contaminant_db.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/chunked_preprocess.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/asset_verification.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/deplete_rrna.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/screen_taxonomy.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/normalize_read_names.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/subsample_reads.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/provenance_snapshot.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/repair_pairs.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/interleave_reads.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/extract_umis.rs",
        "crates/bijux-dna-domain-fastq/src/stages/contract/runtime/deinterleave_reads.rs",
        "crates/bijux-dna-domain-compiler/src/compiler/validation/strict_stage_schemas.rs",
        "crates/bijux-dna-db-ref/src/resolution/reference_assets.rs",
        ...
        "crates/bijux-dna-domain-vcf/src/artifacts.rs",
    ]);
    let needles = [
        "std::fs::write(",
        "fs::write(",
