...
pub fn governed_schema_registry() -> Vec<SchemaRegistryEntryV1> {
    vec![
        ...
        schema_entry(
            ...
            SchemaMigrationRuleV1::AddOptionalFieldsOnly,
            "bijux-dna-runtime",
            "Execution backend descriptor for local, container, and scheduler-backed runs.",
        ),
        schema_entry(
            ...
            SchemaMigrationRuleV1::AddOptionalFieldsOnly,
            "bijux-dna-runtime",
            "Resource-aware runnable placement decision and scheduling warnings.",
        ),
        schema_entry(
            "run_queue_state",
            ...
            SchemaMigrationRuleV1::AddOptionalFieldsOnly,
            "bijux-dna-runtime",
            "Durable queue lifecycle record for deduplication, pause, resume, and cancellation.",
        ),
        schema_entry(
            "run_lease",
            "bijux.run_lease.v1",
            ...
            SchemaMigrationRuleV1::AddOptionalFieldsOnly,
            "bijux-dna-runtime",
            "Exclusive run lease and locking state used to prevent concurrent writers.",
        ),
        schema_entry(
            "run_control",
            ...
            SchemaMigrationRuleV1::AddOptionalFieldsOnly,
            "bijux-dna-runtime",
            "Auditable operator control requests and observed pause/resume/cancel states.",
        ),
        schema_entry(
            "operator_health",
            ...
            SchemaMigrationRuleV1::AddOptionalFieldsOnly,
            "bijux-dna-runtime",
            "Independent operator health checks for runtime prerequisites and evidence linkage.",
        ),
        schema_entry(
            "slurm_submission",
            ...
            SchemaMigrationRuleV1::AddOptionalFieldsOnly,
            "bijux-dna-runtime",
            "Scheduler submission and monitoring record for governed Slurm-backed execution.",
        ),
        schema_entry(
            "run_state",
            "bijux.run_state.v1",
    ...
    vec![
        ...
        ApiRouteAdapterV1 {
            ...
            writes_schema_families: vec![
                ...
                "run_queue_state".to_string(),
                "run_lease".to_string(),
                "run_control".to_string(),
                "operator_health".to_string(),
                "run_state".to_string(),
        ...
        ApiRouteAdapterV1 {
            route_id: "v1.pause_run".to_string(),
            response_struct: "RunControlResponse".to_string(),
            reads_schema_families: vec!["run_control".to_string(), "run_queue_state".to_string()],
            writes_schema_families: vec!["run_control".to_string()],
        },
        ApiRouteAdapterV1 {
            route_id: "v1.resume_run".to_string(),
            response_struct: "RunControlResponse".to_string(),
            reads_schema_families: vec!["run_control".to_string(), "run_queue_state".to_string()],
            writes_schema_families: vec!["run_control".to_string()],
        },
        ApiRouteAdapterV1 {
            route_id: "v1.cancel_run".to_string(),
            response_struct: "RunControlResponse".to_string(),
            reads_schema_families: vec!["run_control".to_string(), "run_queue_state".to_string()],
            writes_schema_families: vec!["run_control".to_string()],
        },
        ApiRouteAdapterV1 {
            route_id: "v1.operator_health".to_string(),
            response_struct: "OperatorHealthResponse".to_string(),
            reads_schema_families: vec![
                "run_backend".to_string(),
                "run_scheduling_decision".to_string(),
                "run_state".to_string(),
            ],
            writes_schema_families: vec!["operator_health".to_string()],
        },
    ]
}
