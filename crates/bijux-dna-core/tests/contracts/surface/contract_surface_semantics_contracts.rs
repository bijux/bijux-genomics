...
fn stage_parameter_canonicalization_resolves_aliases_and_defaults() {
    let stage = StageSpec {
        ...
        metrics: Vec::new(),
        description: None,
        environment_requirements: bijux_dna_core::contract::StageEnvironmentRequirements::default(),
        report_contracts: Vec::new(),
        capability_contract: bijux_dna_core::contract::StageCapabilitySpec::default(),
