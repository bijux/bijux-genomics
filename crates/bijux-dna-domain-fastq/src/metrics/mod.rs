...
pub use types::{
    ...
    FastqQcPostMetricsV1, FastqQcSummaryMetricsV1, FastqScanMetricsV1, FastqStatsNeutralMetricsV1,
    FastqTrimMetricsV1, FastqUmiMetricsV1, FastqValidateMetricsV1, FastqcToolMetricsV1,
