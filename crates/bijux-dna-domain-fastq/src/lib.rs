...
pub use stages::{
    ...
    STAGE_CHIMERA_DETECTION, STAGE_CORRECT, STAGE_DEDUPLICATE, STAGE_DETECT_ADAPTERS, STAGE_FILTER,
    STAGE_DAMAGE_AWARE_PRETRIM, STAGE_LOW_COMPLEXITY, STAGE_MERGE, STAGE_OTU_CLUSTERING, STAGE_PREFIX, STAGE_PREPROCESS,
