...
pub use stages::{
    ...
    STAGE_CHIMERA_DETECTION, STAGE_CORRECT_ERRORS, STAGE_TRIM_TERMINAL_DAMAGE, STAGE_REMOVE_DUPLICATES,
    STAGE_DETECT_ADAPTERS, STAGE_FILTER_READS, STAGE_FILTER_LOW_COMPLEXITY, STAGE_MERGE_PAIRS, STAGE_OTU_CLUSTERING,
    STAGE_PREFIX, STAGE_PRIMER_NORMALIZATION, STAGE_REPORT_QC, STAGE_DEPLETE_RRNA,
