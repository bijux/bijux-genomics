...
pub use stages::{
    ...
    STAGE_CHIMERA_DETECTION, STAGE_CORRECT, STAGE_DAMAGE_AWARE_PRETRIM, STAGE_DEDUPLICATE,
    STAGE_DETECT_ADAPTERS, STAGE_FILTER_READS, STAGE_LOW_COMPLEXITY, STAGE_MERGE, STAGE_OTU_CLUSTERING,
    STAGE_PREFIX, STAGE_PRIMER_NORMALIZATION, STAGE_REPORT_QC, STAGE_RRNA,
    STAGE_SCREEN_TAXONOMY, STAGE_PROFILE_READS, STAGE_TRIM_READS, STAGE_UMI, STAGE_VALIDATE_READS,
};
pub use stages::{
