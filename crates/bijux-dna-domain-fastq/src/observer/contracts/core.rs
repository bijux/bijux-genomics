...
pub(super) const CONTRACTS: &[ObserverSpecializationContract] = &[
    ...
    contract("fastq.profile_read_lengths", "fastp", "report_json"),
    contract("fastq.profile_read_lengths", "prinseq", "report_json"),
    contract("fastq.profile_read_lengths", "seqfu", "report_json"),
