use bijux_dna_core::prelude::invariants::{InvariantSpecV1, InvariantStatusV1};
...
pub fn fastq_invariant_specs() -> Vec<InvariantSpecV1> {
    vec![
        ...
        InvariantSpecV1 {
            ...
            threshold_provenance: "Schema versioned in bijux-dna-core metrics.".to_string(),
            severity: InvariantStatusV1::Fail,
        ...
        InvariantSpecV1 {
            ...
            definition: "Validation reports malformed reads proportion below threshold."
                .to_string(),
            threshold_provenance:
                "Default thresholds in bijux_dna_domain_fastq::InvariantThresholds.".to_string(),
            severity: InvariantStatusV1::Fail,
