...
pub struct TerminalDamageReportV1 {
    ...
    pub terminal_base_composition_pre_r1: BTreeMap<String, u64>,
    pub terminal_base_composition_post_r1: BTreeMap<String, u64>,
...
mod tests {
    ...
    fn terminal_damage_report_contract_round_trips() {
        let report = TerminalDamageReportV1 {
            ...
            terminal_base_composition_pre_r1: [("C".to_string(), 80_u64)].into_iter().collect(),
            terminal_base_composition_post_r1: [("C".to_string(), 30_u64)].into_iter().collect(),
