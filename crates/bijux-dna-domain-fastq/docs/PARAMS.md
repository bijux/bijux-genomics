...
| `fastq.deplete_host` | `HostDepletionEffectiveParams` | host-reference depletion controls, including reference provenance, masking policy, governed thread selection, and canonical report semantics |
