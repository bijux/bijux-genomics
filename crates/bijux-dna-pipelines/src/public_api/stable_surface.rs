...
pub use crate::{
    ...
    evaluate_batch_fan_semantics, evaluate_template_admission, merge_effective_defaults,
    ...
    summarize_cross_domain_evidence, validate_cross_domain_handoff, validate_pipeline_id,
    validate_pipeline_id_str, validate_sample_sheet_preflight, validate_template_overrides,
    ArtifactType, BatchFailureDecisionV1, BatchFanSemanticsReportV1, BatchNodeScopeV1,
    BatchWorkflowSemanticsV1, CrossDomainEvidenceNarrativeV1, CrossDomainEvidenceSummaryV1,
    CrossDomainFailurePolicyV1, CrossDomainHandoffRequestV1, CrossDomainHandoffValidationV1,
