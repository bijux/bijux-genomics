...
fn bam_stage_order(stage: &BamStage) -> usize {
    match stage {
        ...
        BamStage::Markdup => 7,
        BamStage::Complexity => 8,
        BamStage::Coverage => 9,
        BamStage::EndogenousContent => 10,
        BamStage::Damage => 11,
        BamStage::Authenticity => 12,
        BamStage::Contamination => 13,
        BamStage::Sex => 14,
        BamStage::BiasMitigation => 15,
        BamStage::Recalibration => 16,
        BamStage::Haplogroups => 17,
        BamStage::Genotyping => 18,
        BamStage::Kinship => 19,
    }
}
