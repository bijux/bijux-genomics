...
pub use artifacts::{
    ...
    VcfCallingBoundaryV1, VcfCohortQcSampleCaveatV1, VcfCohortQcWorkflowSummaryV1,
    VcfDamageFilterSummaryV1, VcfDemographyRefusalBoundaryV1, VcfFilterConsequenceV1,
    VcfImputationWorkflowBoundaryV1, VcfLikelihoodWorkflowBoundaryV1, VcfNormalizationSummaryV1,
    VcfPanelReferenceDriftReportV1, VcfPanelReferenceSnapshotV1, VcfPcaAdmixtureGuardrailV1,
