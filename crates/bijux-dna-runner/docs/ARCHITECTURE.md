...
- `step_runner/` owns step orchestration plus support modules for contracts, runtime policy, container argument assembly, backend-specific execution, inputs, observer calls, identity, and artifacts.
...
- Keep `step_runner/mod.rs` orchestration-focused and move support logic into companion modules.
