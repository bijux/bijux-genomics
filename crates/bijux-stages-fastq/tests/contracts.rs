...
mod mod_contracts_observer_observer_determinism_rs;
#[path = "contracts/observer/observer_parsers.rs"]
mod mod_contracts_observer_observer_parsers_rs;
...
#[path = "contracts/symmetry.rs"]
mod mod_contracts_symmetry_rs;
