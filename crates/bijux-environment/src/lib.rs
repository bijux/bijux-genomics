...
pub fn default_docker_tools() -> Vec<DockerToolSpec> {
    vec![
        ...
        DockerToolSpec {
            ...
            executable: Some("flash2".to_string()),
            version_cmd: "flash2 --version".to_string(),
            probe_cmd: Some("flash2 --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("flash2 --help".to_string()),
        },
        DockerToolSpec {
        ...
        DockerToolSpec {
            name: "pear".to_string(),
            executable: Some("pear".to_string()),
            version_cmd: "pear --version".to_string(),
            probe_cmd: Some("pear --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("pear --help".to_string()),
        },
        DockerToolSpec {
            name: "prinseq".to_string(),
            executable: Some("prinseq++".to_string()),
            version_cmd: "prinseq++ --version".to_string(),
            probe_cmd: Some("prinseq++ --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("prinseq++ --help".to_string()),
        },
        DockerToolSpec {
            name: "seqtk".to_string(),
            executable: Some("seqtk".to_string()),
            version_cmd: "seqtk --version".to_string(),
            probe_cmd: Some("seqtk --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("seqtk --help".to_string()),
        },
        DockerToolSpec {
            name: "trim_galore".to_string(),
            executable: Some("trim_galore".to_string()),
            version_cmd: "trim_galore --version".to_string(),
            probe_cmd: Some("trim_galore --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("trim_galore --help".to_string()),
        },
        DockerToolSpec {
            name: "trimmomatic".to_string(),
            executable: Some("trimmomatic".to_string()),
            version_cmd: "trimmomatic --version".to_string(),
            probe_cmd: Some("trimmomatic --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("trimmomatic --help".to_string()),
        },
        DockerToolSpec {
            name: "umi_tools".to_string(),
            executable: Some("umi_tools".to_string()),
            version_cmd: "umi_tools --version".to_string(),
            probe_cmd: Some("umi_tools --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("umi_tools --help".to_string()),
        },
        DockerToolSpec {
            name: "musket".to_string(),
            executable: Some("musket".to_string()),
            version_cmd: "musket --version".to_string(),
            probe_cmd: Some("musket --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("musket --help".to_string()),
        },
        DockerToolSpec {
            name: "spades".to_string(),
            executable: Some("spades".to_string()),
            version_cmd: "spades --version".to_string(),
            probe_cmd: Some("spades --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("spades --help".to_string()),
        },
        DockerToolSpec {
            name: "qualimap".to_string(),
            executable: Some("qualimap".to_string()),
            version_cmd: "qualimap --version".to_string(),
            probe_cmd: Some("qualimap --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("qualimap --help".to_string()),
        },
        DockerToolSpec {
            name: "lighter".to_string(),
            executable: Some("lighter".to_string()),
            version_cmd: "lighter --version".to_string(),
            probe_cmd: Some("lighter --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("lighter --help".to_string()),
        },
        DockerToolSpec {
            name: "bayeshammer".to_string(),
            executable: Some("bayeshammer".to_string()),
            version_cmd: "bayeshammer --version".to_string(),
            probe_cmd: Some("bayeshammer --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("bayeshammer --help".to_string()),
        },
        DockerToolSpec {
            name: "seqkit".to_string(),
            executable: Some("seqkit".to_string()),
            version_cmd: "seqkit --version".to_string(),
            probe_cmd: Some("seqkit --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("seqkit --help".to_string()),
        },
        DockerToolSpec {
            name: "vsearch".to_string(),
            executable: Some("vsearch".to_string()),
            version_cmd: "vsearch --version".to_string(),
            probe_cmd: Some("vsearch --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("vsearch --help".to_string()),
        },
        DockerToolSpec {
            name: "bwa".to_string(),
            executable: Some("bwa".to_string()),
            version_cmd: "bwa --version".to_string(),
            probe_cmd: Some("bwa --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("bwa --help".to_string()),
        },
        DockerToolSpec {
            name: "star".to_string(),
            executable: Some("star".to_string()),
            version_cmd: "star --version".to_string(),
            probe_cmd: Some("star --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("star --help".to_string()),
        },
        DockerToolSpec {
            name: "centrifuge".to_string(),
            executable: Some("centrifuge".to_string()),
            version_cmd: "centrifuge --version".to_string(),
            probe_cmd: Some("centrifuge --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("centrifuge --help".to_string()),
        },
        DockerToolSpec {
            name: "metaphlan".to_string(),
            executable: Some("metaphlan".to_string()),
            version_cmd: "metaphlan --version".to_string(),
            probe_cmd: Some("metaphlan --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("metaphlan --help".to_string()),
        },
        DockerToolSpec {
            name: "kaiju".to_string(),
            executable: Some("kaiju".to_string()),
            version_cmd: "kaiju --version".to_string(),
            probe_cmd: Some("kaiju --version".to_string()),
            probe_expected_exit: vec![0],
            help_cmd: Some("kaiju --help".to_string()),
        },
        DockerToolSpec {
