...
#[path = "boundaries/deps/cli_dependency_policy.rs"]
mod mod_boundaries_deps_cli_dependency_policy_rs;
#[path = "boundaries/deps/core_layering.rs"]
mod mod_boundaries_deps_core_layering_rs;
#[path = "boundaries/deps/dependency_boundaries.rs"]
mod mod_boundaries_deps_dependency_boundaries_rs;
#[path = "boundaries/deps/dependency_budgets.rs"]
mod mod_boundaries_deps_dependency_budgets_rs;
#[path = "boundaries/deps/dependency_graph.rs"]
mod mod_boundaries_deps_dependency_graph_rs;
#[path = "boundaries/deps/dev_deps_policy.rs"]
mod mod_boundaries_deps_dev_deps_policy_rs;
#[path = "boundaries/deps/domain_dependency_policy.rs"]
mod mod_boundaries_deps_domain_dependency_policy_rs;
#[path = "boundaries/deps/effect_boundary_map.rs"]
mod mod_boundaries_deps_effect_boundary_map_rs;
#[path = "boundaries/deps/heavy_deps_policy.rs"]
mod mod_boundaries_deps_heavy_deps_policy_rs;
#[path = "boundaries/deps/infra_boundaries.rs"]
mod mod_boundaries_deps_infra_boundaries_rs;
#[path = "boundaries/deps/pipelines_dependency_policy.rs"]
mod mod_boundaries_deps_pipelines_dependency_policy_rs;
#[path = "boundaries/deps/qa_dependency_policy.rs"]
...
#[path = "boundaries/surface/api_boundaries.rs"]
mod mod_boundaries_surface_api_boundaries_rs;
#[path = "boundaries/surface/architecture_pointer_policy.rs"]
...
#[path = "boundaries/surface/id_literal_policy.rs"]
...
#[path = "boundaries/surface/no_helpers_policy.rs"]
...
#[path = "boundaries/surface/no_thin_modules_policy.rs"]
mod mod_boundaries_surface_no_thin_modules_policy_rs;
#[path = "boundaries/surface/ownership_contract.rs"]
mod mod_boundaries_surface_ownership_contract_rs;
#[path = "boundaries/surface/path_policies.rs"]
...
#[path = "boundaries/surface/runner_tree_policy.rs"]
mod mod_boundaries_surface_runner_tree_policy_rs;
#[path = "boundaries/surface/ssot_catalog_authority.rs"]
mod mod_boundaries_surface_ssot_catalog_authority_rs;
#[path = "boundaries/surface/stage_specs_purity.rs"]
mod mod_boundaries_surface_stage_specs_purity_rs;
#[path = "boundaries/surface/style_policy.rs"]
mod mod_boundaries_surface_style_policy_rs;
#[path = "boundaries/surface/test_grouping_policy.rs"]
mod mod_boundaries_surface_test_grouping_policy_rs;
#[path = "boundaries/surface/tool_id_uniqueness.rs"]
