...
pub use compiler::bundle::{
    ...
    DomainMetricCatalog, DomainMetricEntry, DomainRegistryQuery, DomainRegistryQueryKind,
    DomainRegistryReleaseBundle, DomainRegistrySchemas, DomainStageContract,
    DomainToolContract, RegistryDeprecationRecord, RegistryFixtureBinding,
    StageMetricContract, StageParameterDefault, ToolContainerContract,
};
pub use compiler::{
