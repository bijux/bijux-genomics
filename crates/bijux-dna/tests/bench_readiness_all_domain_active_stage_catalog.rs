...
fn bench_readiness_all_domain_active_stage_catalog_reports_governed_rows() {
    ...
    assert_eq!(payload.get("row_count").and_then(serde_json::Value::as_u64), Some(57));
    assert_eq!(
    ...
    assert_eq!(payload.get("stages_with_schema").and_then(serde_json::Value::as_u64), Some(57));
    assert_eq!(
