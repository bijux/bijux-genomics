...
#[test]
fn bench_readiness_vcf_rendered_commands_write_governed_argv_jsonl() {
    ...
    let output = Command::new(env!("CARGO_BIN_EXE_bijux-dna"))
        ...
        .args(["bench", "readiness", "render-vcf-commands"])
        .output()
        .expect("run cli");
    ...
    let jsonl_path = repo_root.join("target/bench-readiness/vcf-rendered-commands.argv.jsonl");
