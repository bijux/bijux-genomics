...
fn bench_readiness_bam_tool_serving_map_reports_governed_bam_stage_rows() {
    ...
    assert!(
        ...
        "BAM readiness map must retain the governed ngsbriggs damage row"
    );
    assert!(
        has_row(
            "bwa",
    ...
    assert!(
        ...
        "BAM readiness map must retain the governed preseq complexity row"
    );
    assert!(
        has_row(
            "multiqc",
    ...
    assert!(
        ...
        "BAM readiness map must retain the governed gatk recalibration row"
    );
    assert!(
        has_row(
            "samtools",
        ...
        "BAM readiness map must retain the governed samtools MAPQ-threshold row"
    );
    assert!(
        has_row(
            "bamtools",
        ...
        "BAM readiness map must retain the governed bamtools MAPQ-threshold row"
    );
    assert!(
        has_row(
            "samtools",
        ...
        "BAM readiness map must retain the governed samtools mixed-filter row"
    );
    assert!(
        has_row(
            "samtools",
    ...
    assert!(
        ...
        "BAM readiness map must retain the governed picard duplication-metrics comparison row"
    );
    assert!(
        has_row(
            "bamtools",
        ...
        "BAM readiness map must retain the governed bamtools mixed-filter row"
    );
    assert!(
        has_row(
            "bedtools",
        ...
        "BAM readiness map must retain the governed bedtools mixed-filter row"
    );
    assert!(
        has_row(
            "picard",
    ...
    assert!(
        ...
        "BAM readiness map must retain the governed picard mapping-summary comparison row"
    );
    assert!(
        has_row(
            "damageprofiler",
