...
fn bench_local_vcf_call_gl_smoke_reports_real_governed_outputs() {
    ...
    assert_eq!(
        ...
        Some("target/local-smoke/vcf.call_gl/bcftools/artifacts/reference/corpus_01_bam_reference.fasta")
    );
    assert_eq!(
        payload.get("output_root").and_then(serde_json::Value::as_str),
        Some("target/local-smoke/vcf.call_gl/bcftools")
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        Some("target/local-smoke/vcf.call_gl/bcftools/gl.vcf.gz.tbi")
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        Some("target/local-smoke/vcf.call_gl/bcftools/stage-result.json")
    );
