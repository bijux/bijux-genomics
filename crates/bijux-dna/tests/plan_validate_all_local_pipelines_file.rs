...
fn plan_validate_all_local_pipelines_writes_governed_report_file() {
    ...
    let output_path = repo_root
        .join("benchmarks/readiness/local-ready/pipeline-dag/all-benchmark-pipelines.json");
    ...
    assert_eq!(
        ...
        "benchmarks/readiness/local-ready/pipeline-dag/all-benchmark-pipelines.json"
    );
