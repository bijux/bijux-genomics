...
#[test]
fn bench_local_core_germline_micro_pipeline_writes_governed_summary_file() {
    ...
    let output = Command::new(env!("CARGO_BIN_EXE_bijux-dna"))
        ...
        .args(["bench", "local", "run-core-germline-micro-pipeline"])
        .output()
        .expect("run cli");
    ...
    assert!(summary_path.is_file(), "core germline pipeline summary must exist");
