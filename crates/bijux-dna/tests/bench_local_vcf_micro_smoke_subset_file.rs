...
#[test]
fn bench_local_vcf_micro_smoke_subset_writes_governed_summary_file() {
    ...
    let output = Command::new(env!("CARGO_BIN_EXE_bijux-dna"))
        ...
        .args(["bench", "local", "run-vcf-micro-smoke-subset"])
        .output()
        .expect("run cli");
    ...
    assert_eq!(rendered_path.trim(), "runs/bench/micro/vcf/MICRO_VCF_SUMMARY.json");
