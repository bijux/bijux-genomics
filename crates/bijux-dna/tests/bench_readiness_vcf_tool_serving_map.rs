...
fn bench_readiness_vcf_tool_serving_map_reports_owned_matrix_rows() {
    ...
    assert!(
        ...
        "VCF tool-serving map must retain the governed plink2 population-structure row"
    );
    assert!(
        has_row(
            "plink2",
    ...
    assert!(
        ...
        "VCF tool-serving map must retain the governed bcftools QC row"
    );
    assert!(
        has_row(
            "plink",
        ...
        "VCF tool-serving map must retain the governed plink QC row"
    );
    assert!(
        has_row(
            "plink2",
        ...
        "VCF tool-serving map must retain the governed plink2 QC row"
    );
    assert!(
        has_row(
            "bcftools",
    ...
    assert!(
        ...
        "VCF tool-serving map must retain the governed imputation row"
    );
    assert!(
        has_row(
            "plink2",
