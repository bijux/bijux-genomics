...
fn bench_readiness_bam_tool_serving_map_writes_governed_tsv_columns() {
    ...
    let tsv_path = repo_root.join("benchmarks/readiness/bam-tool-serving-map.tsv");
    ...
    for row in [
        ...
        "bowtie2\tbam.align\tsupported\trunnable\tparser_fixture_validated\tfixture:corpus-01-mini",
        "preseq\tbam.complexity\tsupported\trunnable\tparser_fixture_validated\tfixture:corpus-01-bam-mini",
        ...
        "samtools\tbam.markdup\tsupported\trunnable\tparser_fixture_validated\tfixture:corpus-01-bam-mini",
        "picard\tbam.markdup\tsupported\trunnable\tparser_fixture_validated\tfixture:corpus-01-bam-mini",
        "samtools\tbam.length_filter\tsupported\trunnable\tparser_fixture_validated\tfixture:corpus-01-bam-mini",
