...
fn bench_readiness_vcf_active_stage_tool_matrix_reports_every_retained_binding() {
    ...
    assert_eq!(scope_state_counts.get("active").and_then(serde_json::Value::as_u64), Some(21));
    assert_eq!(
    ...
    assert_eq!(scope_detail_counts.get("active").and_then(serde_json::Value::as_u64), Some(21));
    assert_eq!(
