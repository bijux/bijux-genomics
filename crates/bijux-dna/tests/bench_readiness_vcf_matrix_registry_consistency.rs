...
fn bench_readiness_vcf_matrix_registry_consistency_reports_governed_pass_state() {
    ...
    assert_eq!(payload.get("matrix_row_count").and_then(serde_json::Value::as_u64), Some(20));
    assert_eq!(payload.get("registry_pair_count").and_then(serde_json::Value::as_u64), Some(46));
    assert_eq!(
