...
fn bench_readiness_bam_stage_decision_table_reports_governed_bam_stage_outcomes() {
    ...
    for (stage_id, tool_id, corpus_status) in [
        ...
        ("bam.authenticity", "authenticct", "fixture:corpus-01-adna-damage-mini"),
        ("bam.bias_mitigation", "mapdamage2", "fixture:corpus-01-bam-mini"),
        ("bam.complexity", "preseq", "fixture:corpus-01-bam-mini"),
        ("bam.contamination", "schmutzi", "fixture:corpus-01-adna-bam-mini"),
        ("bam.coverage", "mosdepth", "fixture:corpus-01-bam-mini"),
        ("bam.damage", "mapdamage2", "fixture:corpus-01-adna-damage-mini"),
        ("bam.duplication_metrics", "samtools", "fixture:corpus-01-bam-mini"),
        ("bam.endogenous_content", "samtools", "fixture:corpus-01-bam-mini"),
        ("bam.filter", "samtools", "fixture:corpus-01-bam-mini"),
        ("bam.gc_bias", "picard", "fixture:corpus-01-bam-mini"),
        ("bam.genotyping", "angsd", "fixture:corpus-01-genotyping-mini"),
        ("bam.haplogroups", "yleaf", "fixture:corpus-01-adna-bam-mini"),
        ("bam.insert_size", "picard", "fixture:corpus-01-bam-mini"),
        ("bam.kinship", "king", "fixture:corpus-01-kinship-mini"),
        ("bam.length_filter", "samtools", "fixture:corpus-01-bam-mini"),
        ("bam.mapping_summary", "samtools", "fixture:corpus-01-bam-mini"),
        ("bam.mapq_filter", "samtools", "fixture:corpus-01-bam-mini"),
        ("bam.markdup", "samtools", "fixture:corpus-01-bam-mini"),
        ("bam.overlap_correction", "bamutil", "fixture:corpus-01-bam-mini"),
        ("bam.qc_pre", "samtools", "fixture:corpus-01-bam-mini"),
        ("bam.recalibration", "gatk", "fixture:corpus-01-bam-mini"),
