...
pub enum BenchLocalCommand {
    ...
    #[command(name = "run-vcf-admixture-smoke")]
    RunVcfAdmixtureSmoke(BenchLocalRunVcfAdmixtureSmokeArgs),
    #[command(name = "run-vcf-population-structure-smoke")]
    RunVcfPopulationStructureSmoke(BenchLocalRunVcfPopulationStructureSmokeArgs),
    #[command(name = "run-vcf-ibd-smoke")]
    RunVcfIbdSmoke(BenchLocalRunVcfIbdSmokeArgs),
    #[command(name = "run-vcf-demography-smoke")]
    RunVcfDemographySmoke(BenchLocalRunVcfDemographySmokeArgs),
    #[command(name = "run-vcf-roh-smoke")]
    ...
    #[command(name = "run-vcf-impute-smoke")]
    RunVcfImputeSmoke(BenchLocalRunVcfImputeSmokeArgs),
    #[command(name = "run-vcf-imputation-metrics-smoke")]
    RunVcfImputationMetricsSmoke(BenchLocalRunVcfImputationMetricsSmokeArgs),
    ...
    #[command(name = "validate-vcf-smoke-suite-ready")]
    ValidateVcfSmokeSuiteReady(BenchLocalValidateVcfSmokeSuiteReadyArgs),
    ...
    #[command(name = "validate-all-domain-slurm-shell-syntax")]
    ValidateAllDomainSlurmShellSyntax(BenchLocalValidateAllDomainSlurmShellSyntaxArgs),
    ...
    #[command(name = "run-real-smoke-core-subset")]
    RunRealSmokeCoreSubset(BenchLocalRunRealSmokeCoreSubsetArgs),
...
#[derive(Debug, Args)]
pub struct BenchLocalRunVcfAdmixtureSmokeArgs {
    #[arg(long, default_value = "plink2")]
    pub tool_id: String,
    #[arg(long, default_value_t = false)]
    pub json: bool,
...
#[derive(Debug, Args)]
pub struct BenchLocalRunVcfPopulationStructureSmokeArgs {
    #[arg(long, default_value = "plink2")]
    pub tool_id: String,
    #[arg(long, default_value_t = false)]
    pub json: bool,
...
#[derive(Debug, Args)]
pub struct BenchLocalRunVcfIbdSmokeArgs {
    #[arg(long, default_value = "germline")]
    pub tool_id: String,
    #[arg(long, default_value_t = false)]
    pub json: bool,
}
...
#[derive(Debug, Args)]
pub struct BenchLocalRunVcfDemographySmokeArgs {
    #[arg(long, default_value = "ibdne")]
    pub tool_id: String,
    #[arg(long, default_value_t = false)]
    pub json: bool,
}
...
#[derive(Debug, Args)]
pub struct BenchLocalRunVcfRohSmokeArgs {
    #[arg(long, default_value = "plink2")]
    pub tool_id: String,
    #[arg(long, default_value_t = false)]
    pub json: bool,
...
#[derive(Debug, Args)]
pub struct BenchLocalRunVcfImputeSmokeArgs {
    #[arg(long, default_value = "beagle")]
    pub tool_id: String,
    #[arg(long, default_value_t = false)]
    pub json: bool,
}
...
#[derive(Debug, Args)]
pub struct BenchLocalRunVcfImputationMetricsSmokeArgs {
    #[arg(long, default_value = "beagle")]
    pub tool_id: String,
    #[arg(long, default_value_t = false)]
    pub json: bool,
...
#[derive(Debug, Args)]
pub struct BenchLocalValidateVcfSmokeSuiteReadyArgs {
    #[arg(long)]
    pub output: Option<std::path::PathBuf>,
    #[arg(long, default_value_t = false)]
    pub json: bool,
...
#[derive(Debug, Args)]
pub struct BenchLocalValidateAllDomainSlurmShellSyntaxArgs {
    #[arg(long)]
    pub root: Option<std::path::PathBuf>,
    #[arg(long)]
    pub output: Option<std::path::PathBuf>,
...
#[derive(Debug, Args)]
pub struct BenchLocalValidateAllDomainSlurmResultPathsArgs {
    #[arg(long)]
    pub root: Option<std::path::PathBuf>,
    #[arg(long)]
    pub manifest: Option<std::path::PathBuf>,
...
#[derive(Debug, Args)]
pub struct BenchLocalRenderAllDomainSlurmSubmitManifestArgs {
    #[arg(long)]
    pub root: Option<std::path::PathBuf>,
    #[arg(long)]
    pub output: Option<std::path::PathBuf>,
...
#[derive(Debug, Args)]
pub struct BenchLocalRunRealSmokeCoreSubsetArgs {
    #[arg(long)]
    pub output: Option<std::path::PathBuf>,
    #[arg(long, default_value_t = false)]
    pub json: bool,
