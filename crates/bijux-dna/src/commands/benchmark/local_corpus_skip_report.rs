...
fn build_skip_report(
    ...
    for stage in &compatibility.stages {
        match (
            ...
            (Some(replacement_corpus_id), Some(replacement_corpus_family_id), "fixture") => {
...
mod tests {
    ...
    #[test]
    fn corpus_skip_report_tracks_fixture_skips_and_planner_only_stages() {
        ...
        assert_eq!(report.skip_count, 172);
        assert_eq!(report.planner_only_stage_count, 8);
        assert!(
