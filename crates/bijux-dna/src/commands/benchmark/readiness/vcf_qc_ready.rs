...
const REQUIRED_HWE_PVALUE_MEAN: f64 = 0.825_656;
...
fn build_vcf_qc_ready_row(
    ...
    let smoke_ready = smoke_report.is_some_and(qc_smoke_matches_governed_contract);
    if !smoke_ready {
    ...
    VcfQcReadyRow {
        ...
        smoke_qc_json_path: smoke_report
            .map_or_else(no_value_string, |report| report.qc_json_path.clone()),
        smoke_qc_summary_path: smoke_report
            .map_or_else(no_value_string, |report| report.qc_summary_path.clone()),
        smoke_qc_tables_path: smoke_report
            .map_or_else(no_value_string, |report| report.qc_tables_path.clone()),
        smoke_imputation_qc_path: smoke_report
            .map_or_else(no_value_string, |report| report.imputation_qc_path.clone()),
        ...
        smoke_qc_histograms_path: smoke_report
            .map_or_else(no_value_string, |report| report.qc_histograms_path.clone()),
        ...
        smoke_maf_summary: smoke_report
            .map_or_else(empty_maf_summary, |report| report.maf_summary.clone()),
        smoke_heterozygosity: smoke_report
            .map_or_else(empty_heterozygosity, |report| report.heterozygosity.clone()),
        smoke_hwe_summary: smoke_report
            .map_or_else(empty_hwe_summary, |report| report.hwe_summary.clone()),
        ...
        smoke_sample_missingness_exclusion_threshold: smoke_report
            .map_or(0.0, |report| report.sample_missingness_exclusion_threshold),
        smoke_variant_missingness_exclusion_threshold: smoke_report
            .map_or(0.0, |report| report.variant_missingness_exclusion_threshold),
        required_metric_names,
        missing_surfaces,
        coverage_status,
        reason,
