...
const VCF_PARSER_FAILURE_CASES: &[VcfParserFailureCase] = &[
    VcfParserFailureCase {
        ...
        fixture_dir: "tests/fixtures/bench/parsers/vcf/bcftools/vcf.call",
    ...
    VcfParserFailureCase {
        ...
        fixture_dir: "tests/fixtures/bench/parsers/vcf/bcftools/vcf.postprocess",
    ...
    VcfParserFailureCase {
        ...
        fixture_dir: "tests/fixtures/bench/parsers/vcf/phasing/shapeit5",
    ...
    VcfParserFailureCase {
        ...
        fixture_dir: "tests/fixtures/bench/parsers/vcf/eigensoft/pca",
    ...
    VcfParserFailureCase {
        ...
        fixture_dir: "tests/fixtures/bench/parsers/vcf/imputation/beagle/vcf.impute",
    ...
    VcfParserFailureCase {
        ...
        fixture_dir: "tests/fixtures/bench/parsers/vcf/segments/germline/vcf.ibd/complete",
