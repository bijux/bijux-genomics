...
mod tests {
    ...
    fn render_all_domain_output_contract_coverage_reports_complete_active_rows() {
        ...
        assert_eq!(report.proof_source_counts.get(PROOF_SOURCE_FASTQ), Some(&69));
        ...
        assert!(
            report.index_declared_row_count + report.index_not_applicable_row_count
                <= report.row_count
        );
        assert_eq!(
        ...
        assert_eq!(
            report.coverage_status_counts.get(COVERAGE_STATUS_COVERED),
