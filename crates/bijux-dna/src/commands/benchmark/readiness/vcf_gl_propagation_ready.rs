...
fn build_vcf_gl_propagation_ready_row(
    ...
    VcfGlPropagationReadyRow {
        ...
        smoke_output_bcf_path: smoke_report
            .map(|report| report.output_bcf_path.clone())
            .unwrap_or_else(no_value_string),
        smoke_output_bcf_csi_path: smoke_report
            .map(|report| report.output_bcf_csi_path.clone())
            .unwrap_or_else(no_value_string),
        ...
        smoke_lost_fields: smoke_report
            ...
            .unwrap_or_default(),
        smoke_site_count_before: smoke_report.map(|report| report.site_count_before).unwrap_or(0),
        smoke_site_count_after: smoke_report.map(|report| report.site_count_after).unwrap_or(0),
