...
mod tests {
    ...
    fn render_all_domain_adapter_coverage_reports_complete_active_rows() {
        ...
        assert_eq!(report.rendered_command_binding_count, 121);
        ...
        assert_eq!(report.command_source_counts.get("vcf_bcftools_adapter"), Some(&9));
        assert_eq!(report.coverage_status_counts.get("covered"), Some(&121));
