use crate::commands::command_prelude::{
    ...
    bench_fastq_trim, bench_fastq_validate_reads, cli, compare_runs,
    ...
    objective_spec, preprocess_args_from_cli, qc_class_label, render,
    resolve_adapter_selection, resolve_effective_adapters, write_trim_report,
    write_validate_report, AdapterPresetsV1, AdapterSelection, Cli, DnaCommand, FastqCommand,
    Objective, Path, PathBuf, Result, StageId,
};
