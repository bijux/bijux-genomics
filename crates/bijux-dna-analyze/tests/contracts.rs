...
mod mod_contracts_report_report_completeness_blessed_rs;
#[path = "contracts/report/report_completeness_contract.rs"]
mod mod_contracts_report_report_completeness_contract_rs;
#[path = "contracts/report/report_contract.rs"]
mod mod_contracts_report_report_contract_rs;
#[path = "contracts/report/report_determinism.rs"]
