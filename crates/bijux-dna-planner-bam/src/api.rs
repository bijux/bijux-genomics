...
pub mod stage_api {
    ...
    pub use crate::local_smoke::{
        local_filter_smoke_plans, local_mapping_summary_smoke_plans, local_mapq_filter_smoke_plans,
        local_qc_pre_smoke_plans, local_validate_smoke_plans, LocalFilterSmokeCasePlan,
