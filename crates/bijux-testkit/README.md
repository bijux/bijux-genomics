...
Current utilities: canonical JSON ordering via `snapshots::stable_json`.
...
See `docs/INDEX.md`, `docs/PUBLIC_API.md`, `docs/FIXTURE_STANDARDS.md`, `docs/SNAPSHOT_POLICY.md`,
`docs/USAGE.md`, `docs/ARCHITECTURE.md`, `docs/CHANGE_RULES.md`.
