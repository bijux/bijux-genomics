...
## v1 scope
Includes pre/core/downstream phase params and the BAM metrics surfaced in `crates/bijux-dna-domain-bam/docs/METRICS.md`.

## Key contracts it owns/consumes
Domain JSON shapes and fixtures.

## Artifacts / Contracts
See `crates/bijux-dna-domain-bam/docs/DOMAIN_MODEL.md` and the snapshot fixtures under `tests/fixtures/`.

## Effects & determinism guarantees
Pure data/validation. See `crates/bijux-dna-domain-bam/docs/EFFECTS.md` and the golden tests below.

## How to run its tests
See `crates/bijux-dna-domain-bam/docs/TESTS.md`. Golden tests: `tests/invariants/phase_semantics.rs`,
