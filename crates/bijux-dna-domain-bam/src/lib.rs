...
pub use artifacts::{
    ...
    BamFlagstatCountsV1, BamMapqFilterSummaryV1, BamMapqRegimeV1, BamMappingSummaryV1,
    BamReferenceAssetIdentityV1, BamReferencePreflightV1, BamSampleIdentityV1,
    BamValidationSummaryV1,
    ...
    BAM_REFERENCE_PREFLIGHT_SCHEMA_VERSION, BAM_SAMPLE_IDENTITY_SCHEMA_VERSION,
