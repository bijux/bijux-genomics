...
pub use artifacts::{
    ...
    BamInsertSizeSummaryV1, BamKinshipPrerequisitesV1, BamLengthFilterSummaryV1,
    BamMappingSummaryV1, BamMapqFilterSummaryV1, BamMapqRegimeV1, BamMarkdupSummaryV1,
    BamMergeCompatibilityV1, BamMergeInputIdentityV1, BamOverlapCorrectionSummaryV1,
    BamPostAlignmentChainV1, BamQcPreSummaryV1, BamReadGroupMappingCountV1,
