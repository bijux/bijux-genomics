...
pub use artifacts::{
    ...
    summarize_tiny_bam_coverage, summarize_tiny_bam_duplication_metrics,
    ...
    BamCoverageRegimeV1, BamCoverageSummaryV1, BamDamageEvidenceV1, BamDuplicateComparisonV1,
