...
pub use artifacts::{
    ...
    execute_bam_validation, propagate_bam_sample_identity, required_bam_bench_corpus_scenarios,
    sort_and_index_tiny_bam, BamAdnaWorkflowV1, BamAdvisoryBoundaryV1, BamAlignmentProvenanceV1,
