...
pub use artifacts::{
    ...
    required_bam_bench_corpus_scenarios, sort_and_index_tiny_bam, summarize_bam_markdup,
    summarize_tiny_bam_coverage, summarize_tiny_bam_mapping, summarize_tiny_bam_qc_pre,
    ...
    BamFilterSummaryV1, BamFlagstatCountsV1, BamHaplogroupReadinessV1, BamInputOriginV1,
    BamInputScaleV1, BamKinshipPrerequisitesV1, BamLengthFilterSummaryV1, BamMappingSummaryV1,
