...
pub use artifacts::{
    ...
    summarize_bam_duplication_metrics, summarize_bam_gc_bias, summarize_bam_insert_size,
    summarize_bam_markdup, summarize_tiny_bam_complexity, summarize_tiny_bam_coverage,
