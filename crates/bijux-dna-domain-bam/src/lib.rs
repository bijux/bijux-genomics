...
pub use artifacts::{
    ...
    BamDuplicationMetricsSummaryV1, BamEndogenousContentEstimateV1, BamFilterSummaryV1,
    BamFlagstatCountsV1, BamGcBiasBinSummaryV1, BamGcBiasSummaryV1, BamGcBiasTruthSummaryV1,
    BamHaplogroupReadinessV1, BamInputOriginV1, BamInputScaleV1, BamInsertSizeHistogramBinV1,
