...
pub use artifacts::{
    ...
    required_bam_bench_corpus_scenarios, sort_and_index_tiny_bam,
    summarize_bam_duplication_metrics, summarize_bam_markdup, summarize_tiny_bam_coverage,
    ...
    BAM_FILTER_SUMMARY_SCHEMA_VERSION, BAM_HAPLOGROUP_READINESS_SCHEMA_VERSION,
