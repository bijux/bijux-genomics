...
pub use crate::model::{
    ...
    SpeciesAuthorityEntry, SupportedFeatures, VcfPanelMaterializationReport,
};
...
pub use crate::resolution::{
    ...
    materialize_vcf_panel_assets, validate_reference_index_qa, validate_imputation_tool_compatibility,
};
