...
#[test]
fn local_detect_duplicates_premerge_smoke_plans_use_governed_corpus_fixtures() -> Result<()> {
    ...
    let duplicate_hit = plans
        ...
        .unwrap_or_else(|| {
            panic!("human_like_pe_duplicate_signals case missing from local duplicate smoke plans")
        });
