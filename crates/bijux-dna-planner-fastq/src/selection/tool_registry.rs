...
pub fn tool_registry() -> BTreeMap<ToolId, ToolAdapterEntry> {
    ...
    for (tool_id, adapter_id) in [
        (
            ToolId::from_static("adapterremoval"),
        ...
        (ToolId::from_static("skewer"), id_catalog::FASTQ_TRIM),
        (ToolId::from_static("leehom"), id_catalog::FASTQ_TRIM),
        (ToolId::from_static("alientrimmer"), id_catalog::FASTQ_TRIM),
        (ToolId::from_static("fastx_clipper"), id_catalog::FASTQ_TRIM),
        ...
        (
            ToolId::from_static("fastq-scan"),
            id_catalog::FASTQ_STATS_NEUTRAL,
        ),
        (
            ToolId::from_static("seqfu"),
            id_catalog::FASTQ_STATS_NEUTRAL,
        ),
        (ToolId::from_static("multiqc"), id_catalog::FASTQ_QC_POST),
        (ToolId::from_static("kraken2"), id_catalog::FASTQ_SCREEN),
        (ToolId::from_static("krakenuniq"), id_catalog::FASTQ_SCREEN),
        (ToolId::from_static("bracken"), id_catalog::FASTQ_SCREEN),
        ...
        (
            ToolId::from_static("fastq_screen"),
