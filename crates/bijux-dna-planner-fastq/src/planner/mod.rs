...
pub use crate::selection::{
    ...
    select_detect_adapters_tools, select_detect_duplicates_premerge_tools,
    select_filter_low_complexity_tools, select_filter_tools, select_index_reference_tools,
    select_infer_asvs_tools, select_merge_tools, select_normalize_abundance_tools,
    select_normalize_primers_tools, select_profile_overrepresented_tools,
    select_profile_read_lengths_tools, select_qc_post_tools, select_remove_chimeras_tools,
    select_remove_duplicates_tools, select_screen_tools, select_stats_tools, select_trim_tools,
    select_umi_tools, select_validate_tools,
};
use benchmark::{
