...
pub use local_smoke::{
    ...
    local_trim_polyg_tails_smoke_plans, local_trim_terminal_damage_smoke_plans,
    ...
    LocalNormalizePrimersSmokeCasePlan, LocalTrimPolygTailsSmokeCasePlan,
    LocalTrimTerminalDamageSmokeCasePlan,
