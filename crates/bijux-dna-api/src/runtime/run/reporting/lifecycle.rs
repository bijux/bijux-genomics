...
pub(super) fn status(run_dir: &Path) -> RunStatus {
    ...
    RunStatus {
        ...
        artifact_inventory_path: None,
        artifact_inventory_text_path: None,
        replay_manifest_path: None,
        hash_ledger_path: None,
        run_summary_text_path: None,
        run_state_path: None,
        runtime_policy_path: None,
        executor_descriptor_path: None,
        backend_descriptor_path: None,
        scheduling_decision_path: None,
        queue_state_path: None,
        lease_path: None,
        control_state_path: None,
        health_report_path: None,
        slurm_submission_path: None,
