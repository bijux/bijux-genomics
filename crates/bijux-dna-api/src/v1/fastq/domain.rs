...
/// Returns an error if the repository root cannot be resolved, the governed planner config is
/// invalid, or the plan artifact cannot be written.
pub fn write_local_deplete_host_plan() -> Result<PathBuf> {
    let repo_root = crate::support::workspace::resolve_repo_root()?;
...
/// Returns an error if the repository root cannot be resolved, the governed planner config is
/// invalid, or the plan artifact cannot be written.
pub fn write_local_deplete_reference_contaminants_plan() -> Result<PathBuf> {
    let repo_root = crate::support::workspace::resolve_repo_root()?;
    let plan =
...
/// Returns an error if the repository root cannot be resolved, the governed planner config is
/// invalid, or the plan artifact cannot be written.
pub fn write_local_screen_taxonomy_plan() -> Result<PathBuf> {
    let repo_root = crate::support::workspace::resolve_repo_root()?;
...
pub fn write_local_merge_pairs_smoke_report() -> Result<PathBuf> {
    crate::internal::fastq::stages::merge_pairs::write_local_merge_pairs_smoke_report()
}
