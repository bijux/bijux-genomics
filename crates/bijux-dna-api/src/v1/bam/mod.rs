...
pub use domain::write_local_haplogroups_smoke_report;
#[cfg(feature = "bam_downstream")]
...
pub use domain::{
    ...
    write_local_contamination_smoke_report, write_local_coverage_smoke_summary,
    write_local_damage_smoke_report, write_local_duplication_metrics_smoke_report,
    write_local_endogenous_content_smoke_report, write_local_filter_smoke_report,
    write_local_gc_bias_smoke_summary, write_local_insert_size_smoke_report,
    ...
    write_local_overlap_correction_smoke_report, write_local_qc_pre_smoke_report,
    write_local_recalibration_smoke_report, write_local_sex_smoke_report,
    write_local_sex_tool_smoke_report, write_local_validate_smoke_report,
};
