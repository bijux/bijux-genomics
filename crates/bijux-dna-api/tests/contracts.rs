...
#[path = "contracts/v1_bam_local_contamination_smoke.rs"]
mod mod_contracts_v1_bam_local_contamination_smoke_rs;
...
#[path = "contracts/v1_bam_local_sex_tool_smoke.rs"]
mod mod_contracts_v1_bam_local_sex_tool_smoke_rs;
...
#[path = "contracts/v1_run_bundle_verifier.rs"]
mod mod_contracts_v1_run_bundle_verifier_rs;
#[path = "contracts/v1_run_cache_explain.rs"]
mod mod_contracts_v1_run_cache_explain_rs;
#[path = "contracts/v1_run_failure_injection.rs"]
mod mod_contracts_v1_run_failure_injection_rs;
#[path = "contracts/v1_run_replay_failed.rs"]
mod mod_contracts_v1_run_replay_failed_rs;
#[path = "contracts/v1_run_replay_success.rs"]
mod mod_contracts_v1_run_replay_success_rs;
#[path = "contracts/v1_run_workflows.rs"]
mod mod_contracts_v1_run_workflows_rs;
