...
| fastq.merge_pairs | Recommended | paired FASTQ | merged FASTQ | merge_rate |
...
| fastq.correct_errors | Optional | FASTQ | corrected FASTQ | correction_rate |
| fastq.extract_umis | Optional | FASTQ | umi FASTQ | umi_stats |
