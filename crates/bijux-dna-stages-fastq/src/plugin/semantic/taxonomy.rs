...
fn deplete_rrna_metrics(artifacts: &[ArtifactRef]) -> Option<serde_json::Value> {
    ...
    Some(serde_json::json!({
        ...
        "rrna_filtered_reads_r1": report.output_r1,
        "rrna_filtered_reads_r2": report.output_r2,
        "rrna_removed_reads_r1": report.removed_reads_r1,
        "rrna_removed_reads_r2": report.removed_reads_r2,
...
fn deplete_reference_contaminants_metrics(artifacts: &[ArtifactRef]) -> Option<serde_json::Value> {
    ...
    Some(serde_json::json!({
        ...
        "removed_contaminant_reads_r1": report.removed_reads_r1,
        "removed_contaminant_reads_r2": report.removed_reads_r2,
        "reads_removed": report.reads_removed,
