...
## Run layout root
From `RunLayout`:
- `run_layout.json` (schema: `tests/fixtures/runtime_schema/default/run_layout_v1.json`)
- `execution_manifest.json` (engine emits execution plan manifest)
- `run_manifest.json` (schema: `tests/fixtures/runtime_schema/default/run_manifest_v1.json`)
- `run_record.json` (schema: `tests/fixtures/runtime_schema/default/run_record_v1.json`)
- `run_provenance.json` (schema: `tests/fixtures/runtime_schema/default/run_provenance_v1.json`)
- `run_metadata.json`
- `environment.json`
- `events.jsonl`
