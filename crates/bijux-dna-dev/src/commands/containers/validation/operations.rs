...
pub(in super::super) fn check_cross_runtime_representative(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn check_cross_runtime_representative_at_paths(
...
pub(in super::super) fn check_cross_runtime_smoke(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
    let docker_dir = PathBuf::from(env_or_default(
        "DOCKER_DIR",
        &workspace
            .path("artifacts/containers/docker-arm64")
...
pub(in super::super) fn check_cross_runtime_smoke_at_paths(
    workspace: &Workspace,
    docker_dir: PathBuf,
    apptainer_dir: PathBuf,
) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn check_smoke_failure_classification(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn check_smoke_contract(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn check_smoke_contract_lock(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn vcf_imputation_core_tools() -> [&'static str; 8] {
    [
        "glimpse", "impute5", "minimac4", "shapeit5", "beagle", "eagle", "bcftools", "plink2",
    ]
}

pub(in super::super) fn load_summary_rows(path: &std::path::Path) -> Result<BTreeMap<String, serde_json::Value>> {
...
pub(in super::super) fn normalized_parity_output(value: &str) -> String {
    value
        .chars()
        .map(|ch| {
...
pub(in super::super) fn check_vcf_imputation_toolchain(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
    let required =
...
pub(in super::super) fn check_imputation_runtime_constraints(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn check_imputation_network_policy(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn check_imputation_hardening(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn check_imputation_release_smoke(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn check_imputation_cross_runtime_parity(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
    let docker_summary = PathBuf::from(env_or_default(
        "DOCKER_SUMMARY",
        &workspace
            .path("artifacts/containers/docker-arm64/summary.json")
...
pub(in super::super) fn git_show_file(workspace: &Workspace, revision: &str, path: &str) -> Result<String> {
...
pub(in super::super) fn walk_paths(root: &std::path::Path) -> Result<Vec<PathBuf>> {
    let mut out = Vec::new();
    if !root.exists() {
        return Ok(out);
    }
...
pub(in super::super) fn check_build_provenance(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn check_digest_changes_on_version_change(
    workspace: &Workspace,
) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn check_digest_output_policy(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn check_runtime_tool_digest_recording(workspace: &Workspace) -> Result<ContainerCommandOutcome> {
