...
pub(in super::super) fn run_env_prep(
    workspace: &Workspace,
    args: &[String],
) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn run_env_smoke(
    workspace: &Workspace,
    args: &[String],
) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn run_container_smoke(
    workspace: &Workspace,
    args: &[String],
) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn run_containers_smoke(
    workspace: &Workspace,
    args: &[String],
) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn run_build_contract(
    workspace: &Workspace,
    tools_csv: &str,
) -> Result<ContainerCommandOutcome> {
    let container_type = checked_container_type()?;
...
pub(in super::super) fn run_test_images(
    workspace: &Workspace,
    args: &[String],
) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn run_test_images_tool(
    workspace: &Workspace,
    args: &[String],
) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn run_image_smoke_vcf(
    workspace: &Workspace,
    args: &[String],
) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn run_image_qa(
    workspace: &Workspace,
    args: &[String],
) -> Result<ContainerCommandOutcome> {
...
pub(in super::super) fn run_apptainer_ensure(
    workspace: &Workspace,
    args: &[String],
) -> Result<ContainerCommandOutcome> {
