...
fn generate_schema_registry_doc(_workspace: &Workspace, out: &Path) -> Result<()> {
    let mut lines = vec![
        ...
        String::new(),
        "## Scope".to_string(),
        "Schema and error compatibility contracts exposed by governed registries.".to_string(),
        String::new(),
        "## Non-goals".to_string(),
        "- Replacing crate-level API or data model documentation.".to_string(),
        String::new(),
        "## Contracts".to_string(),
        "- Generated-only document; manual edits are forbidden.".to_string(),
        "- Registry rows must remain deterministic for a fixed repository state.".to_string(),
        String::new(),
...
fn generate_api_versioning_doc(_workspace: &Workspace, out: &Path) -> Result<()> {
    ...
    let mut lines = vec![
        ...
        String::new(),
        "## Scope".to_string(),
        "Route-level schema read/write surfaces declared by the v1 API inventory.".to_string(),
        String::new(),
        "## Non-goals".to_string(),
        "- Replacing endpoint behavior documentation or payload examples.".to_string(),
        String::new(),
        "## Contracts".to_string(),
        "- Generated-only document; manual edits are forbidden.".to_string(),
        "- Route entries must be sourced from the governed API inventory.".to_string(),
        String::new(),
...
fn generate_deprecation_dashboard_doc(workspace: &Workspace, out: &Path) -> Result<()> {
    ...
    let mut lines = vec![
        ...
        String::new(),
        "## Scope".to_string(),
        "Compatibility deprecations declared in `configs/ci/compatibility/deprecations.toml`.".to_string(),
        String::new(),
        "## Non-goals".to_string(),
        "- Replacing migration playbooks or release planning records.".to_string(),
        String::new(),
        "## Contracts".to_string(),
        "- Generated-only document; manual edits are forbidden.".to_string(),
        "- Rows must mirror governed compatibility deprecation declarations.".to_string(),
        String::new(),
...
fn generate_upgrade_guide_doc(workspace: &Workspace, out: &Path) -> Result<()> {
    ...
    let mut lines = vec![
        ...
        String::new(),
        "## Non-goals".to_string(),
        "- Replacing detailed operational runbooks or incident procedures.".to_string(),
        String::new(),
        "## Contracts".to_string(),
        "- Generated-only document; manual edits are forbidden.".to_string(),
        "- Change rows must stay aligned with governed release change config.".to_string(),
        String::new(),
