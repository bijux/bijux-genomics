...
pub fn check_registry() -> Vec<CheckDefinition> {
    vec![
        ...
        native("check-deny-policy-deviations", NativeCheckKey::DenyPolicyDeviations),
        native(
        ...
        native("check-benchmark-integrity-policy", NativeCheckKey::BenchmarkIntegrityPolicy),
        native("check-cargo-config-policy", NativeCheckKey::CargoConfigPolicy),
        native("check-certification-schema-docs", NativeCheckKey::CertificationSchemaDocs),
        ...
        native("check-clippy-allowlist-expiry", NativeCheckKey::ClippyAllowlistExpiry),
        native("check-clippy-allowlist-growth", NativeCheckKey::ClippyAllowlistGrowth),
        ...
        native("check-docs-build-contract", NativeCheckKey::DocsBuildContract),
        native("check-docs-requirements-lock", NativeCheckKey::DocsRequirementsLock),
        ...
        native("check-examples-runner-contract", NativeCheckKey::ExamplesRunnerContract),
        ...
        native("check-hpc-rsync-docs-parity", NativeCheckKey::HpcRsyncDocsParity),
        ...
        native("check-no-parallel-accidental", NativeCheckKey::AutomationParallelism),
        native("check-no-raw-cargo-in-makes", NativeCheckKey::NoRawCargoInMakes),
        native("check-no-raw-cargo-in-automation", NativeCheckKey::NoRawCargoInAutomation),
        native("check-no-target-paths-in-tests", NativeCheckKey::NoTargetPathsInTests),
        native("check-automation-temp-discipline", NativeCheckKey::AutomationTempDiscipline),
        native("check-no-user-path-literals", NativeCheckKey::NoUserPathLiterals),
        ...
        policy("check-registry-required-tools-parity", "tool_registry_reproducibility_policy"),
        ...
        native("check-rustflags-consistency", NativeCheckKey::RustflagsConsistency),
        ...
        native("check-vcf-compatibility-matrix", NativeCheckKey::VcfCompatibilityMatrix),
        ...
        policy_alias("check-stage-registry-fixtures", "stage_registry_fixture_completeness"),
        CheckDefinition {
...
fn policy_alias(id: &'static str, filter: &'static str) -> CheckDefinition {
    CheckDefinition { execution_mode: ExecutionMode::Alias, ..policy(id, filter) }
}
