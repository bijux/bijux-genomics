...
pub(crate) fn qc_class_label(stage: &str) -> Option<&'static str> {
    match bijux_dna_api::v1::api::bench::qc_class_for_stage(stage) {
        Some(bijux_dna_api::v1::api::bench::QcClass::Structural) => Some("structural"),
        Some(bijux_dna_api::v1::api::bench::QcClass::Statistical) => Some("statistical"),
        None => None,
    }
}
