...
./scripts/tooling/generate-domain-coverage-doc.sh --out "$OUT_ROOT/20-science/DOMAIN_COVERAGE.generated.md" >/dev/null
cargo run -q -p bijux-dev-dna -- containers run generate-qa-matrix -- "$OUT_ROOT/30-operations/APPTAINER_QA_MATRIX.md" >/dev/null
