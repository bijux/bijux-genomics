...
lines.append("- Entry point: `containers/index.md`")
lines.append("- Policy: `containers/docs/PROMOTION_POLICY.md`")
lines.append("- Lifecycle: `containers/docs/TOOL_LIFECYCLE.md`")
lines.append("- Version authority: `containers/docs/VERSION_AUTHORITY.md`")
lines.append("- Lock lifecycle: `containers/docs/LOCK_LIFECYCLE.md`")
lines.append("- HPC frontend build authority: `containers/docs/FRONTEND_BUILD_AUTHORITY.md`")
...
lines.append("- Security boundary: `containers/docs/SECURITY_BOUNDARY.md`")
lines.append("- Multiarch policy: `containers/docs/MULTIARCH_POLICY.md`")
