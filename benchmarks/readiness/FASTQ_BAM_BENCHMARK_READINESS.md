...
- Ready pairs: 118
- Blocked pairs: 5
- Exact blocker counts: corpus=1, support=4

## Surface Summary

| Surface | Status | Scope | Total | Ready | Blocked | Evidence |
| --- | --- | --- | ---: | ---: | ---: | --- |
| Matrix | attention_required | all governed fastq and bam stage-tool pairs | 123 | 118 | 5 | stages=51, tools=67, gaps=corpus=1, none=118, support=4 |
