...
| total_expected_jobs | 141 | `benchmarks/readiness/expected-benchmark-results-all-domains.tsv` | `row_count` | canonical FASTQ, BAM, and VCF expected benchmark bindings |
| ready_jobs | 138 | `benchmarks/readiness/all-domains/FASTQ_BAM_VCF_BENCHMARK_REPORT.json` | `present_row_count` | expected benchmark jobs with present governed result rows |
