...
Direct benchmark command: `cargo run -q -p bijux-dna -- bench fastq deplete-host --sample-id SAMPLE --r1 reads.fastq.gz --out artifacts --tools auto`
...
4. Collect outputs under `artifacts/examples/fastq_deplete_host_bench/`
