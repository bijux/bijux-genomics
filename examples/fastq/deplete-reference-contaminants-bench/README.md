...
Canonical invocation: `cargo run -q -p bijux-dna-dev -- examples run run fastq_deplete_reference_contaminants_bench`
...
2. `cargo run -q -p bijux-dna-dev -- examples run run fastq_deplete_reference_contaminants_bench`
