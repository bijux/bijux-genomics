...
## Step 3 Bench
- Execute the UMI extraction benchmark flow using the example-pinned suite.

## Step 4 Collect/Report
- Collect outputs in artifacts/examples/fastq_extract_umis_bench/ and produce `bundle.tar.gz`.
