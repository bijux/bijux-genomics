...
from corpus_01_fastq_benchmark_support import (
    ...
    trim_terminal_damage_benchmark_defaults,
...
def main() -> int:
    ...
    requested_tools = (
        ...
        if args.tools
        else TRIM_TERMINAL_DAMAGE_BENCHMARK_CONTRACT.tools
    )
    ...
    payload = {
        ...
        "trim_5p_bases": args.trim_5p_bases,
        "trim_3p_bases": args.trim_3p_bases,
        "requested_trim_5p_bases": args.trim_5p_bases,
        "requested_trim_3p_bases": args.trim_3p_bases,
