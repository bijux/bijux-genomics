...
def tool_runtime_summary(rows: list[dict]) -> list[dict]:
    return summarize_tool_runtime_rows(
        ...
        metric_specs=[
            ...
            BriefingMetricSpec('rrna_fraction_removed', 'mean_rrna_fraction_removed', 'mean'),
...
def sample_runtime_outliers(rows: list[dict]) -> list[dict]:
    return summarize_sample_outlier_rows(
        ...
        selectors=[
            ...
            BriefingOutlierSpec('rrna_fraction_removed', 'max', 'strongest_depletion_tool', 'strongest_rrna_fraction_removed'),
        ],
