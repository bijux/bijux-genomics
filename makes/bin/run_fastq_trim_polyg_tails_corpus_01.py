...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--out-root",
        default="",
        help="Benchmark output root. Defaults to <corpus-root-parent>/results/<corpus-dir>/fastq.trim_polyg_tails/lunarc.",
    )
    parser.add_argument(
        "--platform",
...
def main() -> int:
    ...
    out_root = (
        ...
        if args.out_root
        else default_results_stage_root(corpus_root, TRIM_POLYG_BENCHMARK_CONTRACT.stage_id)
    )
