...
def sample_runtime_outliers(rows: list[dict]) -> list[dict]:
    return summarize_sample_outlier_rows(
        ...
        selectors=[
            ...
            BriefingOutlierSpec('top_fraction', 'max', 'highest_top_fraction_tool', 'highest_top_fraction', parser='float', copied_metrics=(BriefingCopiedMetricSpec('flagged_sequences', 'flagged_sequences'),)),
        ],
