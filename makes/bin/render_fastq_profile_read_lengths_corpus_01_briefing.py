...
def sample_runtime_outliers(rows: list[dict]) -> list[dict]:
    return summarize_sample_outlier_rows(
        ...
        selectors=[
            ...
            BriefingOutlierSpec('distinct_lengths', 'max', 'widest_length_tool', 'widest_length_support', parser='float', copied_metrics=(BriefingCopiedMetricSpec('max_read_length', 'max_read_length'),)),
        ],
