...
from benchmark_fastq_corpus.config import (
...
def _workspace_path(section: str, key: str) -> Path:
    ...
    raise SystemExit(
        ...
        f"[{section}].{key} in {current_workspace_config_path()}"
    )
...
def _workspace_template(section: str, key: str) -> str:
    ...
    raise SystemExit(
        ...
        f"[artifacts.{section}].{key} in {current_workspace_config_path()}"
    )
...
def _workspace_layout_template(section: str, key: str) -> str:
    ...
    raise SystemExit(
        ...
        f"[layout.{section}].{key} in {current_workspace_config_path()}"
    )
...
def _workspace_sync_value(key: str):
    ...
    raise SystemExit(
        ...
        f"[sync.defaults].{key} in {current_workspace_config_path()}"
    )
...
def benchmark_sync_default_pull_base() -> Path:
    ...
    raise SystemExit(
        ...
        f"[sync.defaults].pull_base in {current_workspace_config_path()}"
    )
...
def benchmark_sync_default_pull_mode() -> str:
    ...
    raise SystemExit(
        ...
        f"[sync.defaults].pull_mode in {current_workspace_config_path()}"
    )
...
def benchmark_sync_default_include_profile() -> str:
    ...
    raise SystemExit(
        ...
        f"[sync.defaults].include_profile in {current_workspace_config_path()}"
    )
...
def benchmark_sync_default_exclude_profile() -> str:
    ...
    raise SystemExit(
        ...
        f"[sync.defaults].exclude_profile in {current_workspace_config_path()}"
    )
...
def benchmark_sync_default_clean_context() -> bool:
    ...
    raise SystemExit(
        ...
        f"[sync.defaults].clean_context in {current_workspace_config_path()}"
    )
...
def benchmark_sync_default_allow_dirty() -> bool:
    ...
    raise SystemExit(
        ...
        f"[sync.defaults].allow_dirty in {current_workspace_config_path()}"
    )
...
def benchmark_sync_default_include_containers_manifest() -> bool:
    ...
    raise SystemExit(
        ...
        f"[sync.defaults].include_containers_manifest in {current_workspace_config_path()}"
    )
...
def benchmark_sync_default_data_manifest_glob() -> str:
    ...
    raise SystemExit(
        ...
        f"[sync.defaults].data_manifest_glob in {current_workspace_config_path()}"
    )
