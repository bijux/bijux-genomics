...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--run-root",
        default="",
        help="Benchmark run root. Defaults to <corpus-root-parent>/results/<corpus-dir>/fastq.profile_overrepresented_sequences/lunarc.",
    )
    parser.add_argument(
        "--docs-root",
...
def main() -> int:
    ...
    validate_overrepresented_run_manifest_contract(run_manifest)
    ...
    metadata_by_sample = resolve_corpus_metadata(
        ...
        fallback_stage_id=PROFILE_OVERREPRESENTED_BENCHMARK_CONTRACT.stage_id,
    )
