...
def main() -> int:
    return run_corpus_report(
        parse_args(),
        contract=TRIM_POLYG_BENCHMARK_CONTRACT,
        validate_run_manifest=validate_trim_polyg_run_manifest_contract,
        metadata_fallback_stage_id=TRIM_POLYG_BENCHMARK_CONTRACT.stage_id,
