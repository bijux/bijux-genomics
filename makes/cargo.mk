...
.PHONY: fmt fmt-rs lint lint-rs lint-workspace lint-rustfmt lint-clippy lint-docs lint-configs lint-fast lint-automation lint-scripts test test-rs test-fast test-slow test-slow-rs test-all test-all-rs test-all-frozen audit audit-rs coverage coverage-rs coverage-workspace ci doctor _check _verify-artifact-env \
		...
		realness-gate \
		_policy-fast _ssot-policy-fast _policy-full _policy-no-raw-cargo _test-profile-invariants _registry-lint _unit-contract-fast _release-readiness bench-active-fast bench-parser-fast bench-adapter-fast bench-hpc-asset-staging-render bench-hpc-asset-staging-validate bench-hpc-asset-staging-dry-run bench-hpc-scratch-layout-render bench-hpc-scratch-layout-validate bench-hpc-scratch-layout-dry-run bench-hpc-execution-resolver-render bench-hpc-execution-resolver-validate bench-hpc-execution-resolver-dry-run bench-hpc-stage-benchmark-array-render bench-hpc-stage-benchmark-array-validate bench-hpc-stage-benchmark-array-dry-run bench-hpc-pipeline-node-array-render bench-hpc-pipeline-node-array-validate bench-hpc-pipeline-node-array-dry-run science-fixtures-fast _ci-fast _ci-slow _ci-profile-fast _ci-profile-slow _quick _install-ci-tools release-gate \
