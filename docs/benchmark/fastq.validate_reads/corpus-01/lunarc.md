...
- Generated: 2026-03-26T23:41:01.145624+00:00
...
- Fastest median runtime: `fastqvalidator` at `3.893` seconds.
- Highest pass rate: `fastqvalidator` at `100.0%`.
- Most invalid reads reported: `fastqvalidator` with `0` reads.
...
| --- | ---: | ---: | ---: | ---: | ---: |
| `fastqvalidator` | 20 | 100.0% | 3.893 | 0 | n/a |
