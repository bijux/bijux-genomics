...
- Corpus root: `/System/Volumes/Data/home/bijan/bijux/corpus_01`
- Benchmark root: `/Users/bijan/bijux/bijux-dna-results/corpus_01/fastq.report_qc/lunarc`
...
- `multiqc` ran at `p50=2.276s` with median MultiQC sample count `1.500` and median module count `11.000`.
- Governed evidence stayed stable: median governed QC input count was `6.000` and every published row preserved `reads_out == reads_in` and `bases_out == bases_in`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `multiqc` | 100.0% | 2.274 | 2.276 | 2.356 | 2.483 | 11.000 | 1.500 | 6.000 | 0.000 |

## Cohort behavior

| Tool | Dimension | Cohort | Samples | Mean runtime (s) | Median runtime (s) | Median modules | Median governed inputs | Median contamination |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `multiqc` | `era_layout` | `ancient_pe` | 5 | 2.286 | 2.304 | 11.000 | 6.000 | 0.000 |
| `multiqc` | `era_layout` | `ancient_se` | 5 | 2.361 | 2.349 | 11.000 | 6.000 | 0.000 |
| `multiqc` | `era_layout` | `modern_pe` | 5 | 2.267 | 2.254 | 11.000 | 6.000 | 0.000 |
| `multiqc` | `era_layout` | `modern_se` | 5 | 2.182 | 2.217 | 11.000 | 6.000 | 0.000 |
| `multiqc` | `size_band` | `under_1000mb` | 1 | 2.078 | 2.078 | 11.000 | 6.000 | 0.000 |
| `multiqc` | `size_band` | `under_100mb` | 12 | 2.305 | 2.311 | 11.000 | 6.000 | 0.000 |
| `multiqc` | `size_band` | `under_500mb` | 7 | 2.249 | 2.253 | 11.000 | 6.000 | 0.000 |
