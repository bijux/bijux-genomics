...
## Workflow
```bash
make _benchmark-profile-read-lengths-corpus-01 PLATFORM=lunarc-apptainer CORPUS_ROOT=/home/bijan/bijux/corpus_01
make _benchmark-profile-read-lengths-corpus-01-report CORPUS_ROOT=/home/bijan/bijux/corpus_01
```
