...
## Workflow
```bash
make _benchmark-profile-reads-corpus-01 PLATFORM=lunarc-apptainer CORPUS_ROOT=/home/bijan/bijux/corpus_01
make _benchmark-profile-reads-corpus-01-report CORPUS_ROOT=/home/bijan/bijux/corpus_01
```
