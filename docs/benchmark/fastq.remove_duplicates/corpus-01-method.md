...
- A publishable dossier begins once those entrypoints materialize `docs/benchmark/fastq.remove_duplicates/corpus-01/` under the audit contract described above.
