...
- A publishable dossier begins once those entrypoints materialize `docs/benchmark/fastq.screen_taxonomy/corpus-01/` under the audit contract described above.
