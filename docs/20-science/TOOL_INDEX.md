...
| `dada2` | `transform` | `fastq.infer_asvs` | `bijuxdna/dada2@sha256:930e06fb8e27965ccafae61d4161ab5e32933aea2555e68ad409ef7af43c8245` | `1.30.0` | upstream:https://github.com/benjjneb/dada2 | `production` |
...
| `fastp` | `filter` | `fastq.trim_reads, fastq.filter_reads, fastq.trim_polyg_tails` | `bijuxdna/fastp@sha256:603656aa361eee1cbd1370db9412e588da91708da5542173e5ae74aab71cbc10` | `0.23.4` | upstream:https://github.com/OpenGene/fastp | `production` |
...
| `fastqc` | `trimmer` | `fastq.validate_reads, fastq.detect_adapters, fastq.profile_overrepresented_sequences` | `bijuxdna/fastqc@sha256:e0b83c56262486cab51020e2bb809b391ad9b38ba7a898588ab15b73586ee789` | `0.12.1` | upstream:https://github.com/s-andrews/FastQC | `production` |
