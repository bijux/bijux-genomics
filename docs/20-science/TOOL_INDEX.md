...
| `addeam` | `transform` | `bam.damage` | `bijuxdna/addeam:1.0.0:1.0.0` | `1.0.0` | paper:https://academic.oup.com/bioinformatics/article/doi/10.1093/bioinformatics/btaf407/8205671 | `production` |
...
| `authenticct` | `transform` | `bam.authenticity` | `bijuxdna/authenticct:1.0.0:1.0.0` | `1.0.0` | paper:https://genomebiology.biomedcentral.com/articles/10.1186/s13059-020-02123-y | `production` |
| `bamtools` | `filter` | `bam.filter, bam.mapq_filter, bam.validate` | `bijuxdna/bamtools:2.5.2:2.5.2` | `2.5.2` | paper:https://academic.oup.com/bioinformatics/article/27/12/1691/255399 | `production` |
| `bamutil` | `corrector` | `bam.overlap_correction` | `bijuxdna/bamutil:1.0.15:1.0.15` | `1.0.15` | upstream:https://github.com/statgen/bamUtil | `production` |
...
| `damageprofiler` | `transform` | `bam.authenticity, bam.damage` | `bijuxdna/damageprofiler:1.1:1.1` | `1.1` | paper:https://academic.oup.com/bioinformatics/article/37/20/3652/6247758 | `production` |
...
| `gatk` | `transform` | `bam.recalibration` | `bijuxdna/gatk:4.6.2.0:4.6.2.0` | `4.6.2.0` | paper:https://pmc.ncbi.nlm.nih.gov/articles/PMC2928508/ | `production` |
...
| `mapdamage2` | `transform` | `bam.bias_mitigation, bam.damage` | `bijuxdna/mapdamage2:2.2.2:2.2.2` | `2.2.2` | paper:https://academic.oup.com/bioinformatics/article/29/13/1682/184965 | `production` |
| `minimac4` | `imputation` | `vcf.impute, vcf.imputation` | `registry_lock` | `0.0.0-planned` | planned | `planned` |
| `mosdepth` | `transform` | `bam.coverage` | `bijuxdna/mosdepth:0.3.10:0.3.10` | `0.3.10` | paper:https://academic.oup.com/bioinformatics/article-abstract/34/5/867/4583630 | `production` |
...
| `ngsbriggs` | `transform` | `bam.damage` | `bijuxdna/ngsbriggs:0.1.3:0.1.3` | `0.1.3` | paper:https://pmc.ncbi.nlm.nih.gov/articles/PMC11646307/ | `production` |
...
| `picard` | `transform` | `bam.duplication_metrics, bam.gc_bias, bam.insert_size, bam.length_filter, bam.mapping_summary, bam.markdup` | `bijuxdna/picard:3.3.0:3.3.0` | `3.3.0` | software:https://broadinstitute.github.io/picard/ | `production` |
...
| `pmdtools` | `transform` | `bam.authenticity, bam.damage` | `bijuxdna/pmdtools:0.60:0.60` | `0.60` | paper:https://doi.org/10.1073/pnas.1318934111 | `production` |
...
| `pydamage` | `transform` | `bam.damage` | `bijuxdna/pydamage:1.0.0:1.0.0` | `1.0.0` | paper:https://pubmed.ncbi.nlm.nih.gov/34395085/ | `production` |
...
| `samtools` | `transform` | `bam.coverage, bam.duplication_metrics, bam.endogenous_content, bam.filter, bam.length_filter, bam.mapping_summary, bam.mapq_filter, bam.markdup, bam.qc_pre, bam.validate` | `bijuxdna/samtools:1.21:1.21` | `1.21` | paper:https://pmc.ncbi.nlm.nih.gov/articles/PMC2723002/ | `production` |
...
| `seqfu` | `transform` | `fastq.profile_read_lengths, fastq.profile_reads` | `bijuxdna/seqfu:planned:planned` | `planned` | paper:https://pmc.ncbi.nlm.nih.gov/articles/PMC8148589/ | `planned` |
