...
| `leehom` | `merger` | `fastq.trim_reads, fastq.merge_pairs` | `bijuxdna/leehom:latest-pinned` | `latest-pinned` | upstream:https://github.com/grenaud/leeHom | `experimental` |
| `lighter` | `corrector` | `fastq.correct_errors` | `bijuxdna/lighter@sha256:pending` | `latest-pinned` | upstream:https://github.com/mourisl/Lighter | `experimental` |
...
| `musket` | `corrector` | `fastq.correct_errors` | `bijuxdna/musket@sha256:pending` | `1.1` | upstream:https://github.com/alexdobin/musket | `experimental` |
| `pear` | `merger` | `fastq.merge_pairs` | `bijuxdna/pear@sha256:4e00e9ffabc5ed46115efab5b6bae946913f1713bb314fd4acb7c379c37efae6` | `0.9.6` | upstream:https://github.com/xflouris/PEAR | `production` |
...
| `seqkit` | `filter` | `fastq.trim_reads, fastq.filter_reads, fastq.trim_terminal_damage, fastq.profile_overrepresented_sequences` | `bijuxdna/seqkit@sha256:ca3dc13e3fef5d34927c44b2d8cd2bc6708c2c256f42e51369d7b1203b0d2991` | `2.8.2` | upstream:https://github.com/shenwei356/seqkit/releases/download/v${VERSION_SEQKIT}/seqkit_linux_arm64.tar.gz | `production` |
